...
export default function Footer() {
    return(
        <footer className="bg-gray-50 text-black">
            <div className="grid grid-cols-3 justify-center py-5">
                ...
                <div className="col-span-1 flex flex-col items-center">
                    ...
                    <p className="opacity-50 text-sm">Copyright 2024.
                        <a href="#" className="text-blue-600"> CEONLINE </a> All Rights Reserved.
                    </p>
                </div>
                <div className="col-span-1 flex flex-col items-center">
                    <p>Lebih dekat dengan kami</p>
                    <div className="flex gap-7 pt-4">
                        <a href="#"><img src={Ig} alt="psh" className="w-30 h-10 "/></a>
                        <a href=""><img src={Git} alt="psh" className="w-30 h-10 "/></a>
                        <a href=""><img src={Mail} alt="psh" className="w-30 h-10 "/></a>
                    </div>
                </div>
            </div>
        </footer>
