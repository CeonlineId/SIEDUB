    ...
    <div className="container mx-auto px-4 py-8 m-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 pb-20 pt-10">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl ">
                <div className="bg-[#FF3D00] text-white h-10 md:w-20 md:h-10 flex items-center rounded-lg justify-center mr-0 md:mr-4 p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-8 w">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={b1} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto" />
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={b2} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto" />
                        <div className="flex gap-5 items-center">
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={b3} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto" />
                        <div className="flex gap-5 items-center">
