        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 pb-20 pt-10">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl ">
                ...
                <div className="p-2">
                    ...
                    <h2 className="text-xl font-semibold mb-1 mt-3">Erupsi Gunung Berapi</h2>
                    <p className="text-gray-600 pb-5">Erupsi gunung berapi adalah peristiwa ketika magma, gas, dan material lainnya naik ke permukaan Bumi melalui saluran vulkanik. Tekanan dari dalam Bumi yang mendorong magma ke permukaan merupakan penyebab utama terjadinya erupsi.</p>
                </div>
            </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-8 w">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-36 md:w-20 h-10 flex items-center justify-center mr-4 p-2">
                    1
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Mengikuti Instruksi Evakuasi</h2>
                    <img src={t1} alt="Logo" className="w-96 h-auto mb-3" />
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-28 md:w-16 h-10 flex items-center justify-center mr-4 p-3">
                    2
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Menggunakan Perlindungan Respiratori</h2>
                    <img src={e1} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-40 md:w-20 h-10 flex items-center justify-center mr-4 p-1">
                    3
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Menghindari Daerah Rawan</h2>
                    <img src={l3} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-48 md:w-20 h-10 flex items-center justify-center mr-4 p-1">
                    4
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Mencari Tempat Perlindungan</h2>
                    <img src={l1} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
