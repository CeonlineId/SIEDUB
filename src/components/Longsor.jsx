    ...
    <div className="container mx-auto px-4 py-8 m-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 pb-20 pt-10">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl ">
                <div className="bg-[#FF3D00] text-white w-14 h-10 flex items-center rounded-lg justify-center mr-0 md:mr-4 p-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-8 w">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={l1} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto"/>
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={l3} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto" />
                        <div className="flex gap-5 items-center">
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                ...
                <div className="p-2">
                    ...
                    <img src={l4} alt="Logo" className="w-80 h-44 ml-0 mb-0 md:ml-10 md:mb-3 md:w-96 md:h-auto" />
                        <div className="flex gap-5 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 pt-20">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl ">
                <div className="bg-[#FF3D00] text-white w-20 h-10 px-2 flex items-center rounded-lg justify-center mr-0 md:mr-4 p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
