        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 pb-20 pt-10">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl ">
                ...
                <div className="p-2">
                    ...
                    <h2 className="text-xl font-semibold mb-1 mt-3">Gempa Bumi</h2>
                    <p className="text-gray-600 pb-5">Gempa bumi adalah getaran yang terjadi di permukaan bumi akibat pelepasan energi dari dalam bumi. Penyebab utama gempa bumi adalah pergerakan lempeng tektonik yang saling bergerak atau bertabrakan. Tektonika lempeng ini dapat menyebabkan retakan di dalam bumi yang kemudian memicu terjadinya gempa bumi.</p>
                </div>
            </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-8 w">
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-40 md:w-20 h-10 flex items-center justify-center mr-4 p-2">
                    1
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Jaga Ketenangan dan Hindari Panik</h2>
                    <img src={b1} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
                            <h1 className="font-semibold text-2xl">1</h1>
                            <h2 className="text-md font-semibold">Langkah Pertama</h2>
                        </div>
                    <p className="text-gray-600 pb-5 pl-8">Saat gempa terjadi, cari tempat yang aman di dalam atau di luar bangunan. Hindari tempat dengan risiko benda-benda jatuh, seperti kaca, cermin, atau perabotan berat.</p>
                </div>
            </div>

            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-36 md:w-20 h-10 flex items-center justify-center mr-4 p-3">
                    2
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Cari Tempat Penyelamatan yang Aman</h2>
                    <img src={b3} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
                            <h1 className="font-semibold text-2xl">2</h1>
                            <h2 className="text-md font-semibold">Langkah Kedua</h2>
                        </div>
                    <p className="text-gray-600 pb-5 pl-9">Jika berada di dalam bangunan, cari tempat yang aman di bawah meja, tempat tidur, atau struktur bangunan lain yang kuat. Hindari tempat dengan potensi objek jatuh seperti perabotan yang dapat melukai Anda.</p>
                </div>
            </div>

            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-32 md:w-14 h-10 flex items-center justify-center mr-4 p-1">
                    3
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Hindari Elevator</h2>
                    <img src={g1} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
            ...
            <div className="relative bg-white rounded-lg shadow-lg flex transition duration-300 ease-in-out transform hover:-translate-y-2 hover:shadow-xl">
                <div className="bg-[#FF3D00] text-white rounded-lg w-80 md:w-36 h-10 flex items-center justify-center mr-4 p-1">
                    4
                </div>
                <div className="p-2">
                    <h2 className="font-semibold">Setelah Gempa Bumi Berhenti, Periksa Kondisi Sekitar</h2>
                    <img src={g2} alt="Logo" className="w-96 h-auto mb-3" />
                        <div className="flex gap-5 items-center">
                            <h1 className="font-semibold text-2xl">4</h1>
                            <h2 className="text-md font-semibold">Langkah Keempat</h2>
                        </div>
                    <p className="text-gray-600 pb-5 pl-8">periksa kondisi sekitar Anda segera. Segera keluar dari bangunan jika ada indikasi kerusakan yang serius. Jika Anda terperangkap, berusaha untuk memberi tahu penyelamat potensial posisi Anda dan berkomunikasi melalui telepon atau pesan singkat jika mungkin.</p>
                </div>
            </div>  
        </div>
