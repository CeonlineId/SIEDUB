    ...
    return (
        <>
          ...
          <div className="container mx-auto px-4 ">
            ...
            <form
                className="max-w-screen-md mx-auto grid grid-cols-1 gap-y-2 bg-white p-10 m-8 md:m-32 mb-10 text-center rounded-lg shadow-lg"
                onSubmit={e => {
                  e.preventDefault();
                  saveReportData();
                }}
          ...
          <div className="container mx-auto flex flex-col items-center pb-10">
            <img src={tutor} alt="Tutorial" className="sm:w-63 sm:h-48 md:w-53 md:h-32" />
          </div>
        </div>
    </>
  );
