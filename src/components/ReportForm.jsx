    ...
    <>
          ...
          <div className="flex flex-col py-4 ">
            ...
            >
              <div className="flex items-start justify-start px-1 py-2">
                <svg
                  xmlns="http://www.w3.org/20040/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  stroke="currentColor"
            ...
            <NavLink
              to="/informasi"
              className={`flex items-center px-4 py-2 text-white hover:bg-gray-700 ${informasiBelow ? 'mt-60' : ''}`}
            >
              <div className="flex items-start justify-start px-1 py-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mx-auto p-4 flex justify-center items-center min-h-screen relative">
          ...
          <form
            className="max-w-screen-md mx-auto grid grid-cols-1 gap-y-2 p-10 m-8 md:m-32 mb-10 text-center rounded-lg shadow-lg"
            onSubmit={e => {
              e.preventDefault();
              saveReportData();
            }}
          >
            ...
            <a href="#" className="text-blue-500 underline pb-3">
        ...
        <div className="container mx-auto flex flex-col items-center pb-10">
          <img
            src={tutor}
            alt="Tutorial"
            className="sm:w-63 sm:h-48 md:w-53 md:h-32"
          />
        </div>
      </div>
    </>
