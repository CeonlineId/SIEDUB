    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 m-10">
        <div className="col-span-1 flex flex-col justify-center md:text-center">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 px-10 items-center">
            <div className="flex justify-center">
              <button
                onClick={() => navigate('/edukasi')}
                className="bg-[#FF3D00] border-2 hover:bg-orange-700 focus:bg-orange-700 text-white focus:text-white font-semibold py-2 px-28 rounded"
              >
                Mulai
              </button>
            </div>
